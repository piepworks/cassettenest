...
def subscription_banner(request):
    ...
    messages = {
        ...
        "past_due": "Looks like there’s a problem with your subscription. "
        f'<a href="{settings_url}">Please check your billing settings.</a>',
        "paused": "Your subscription is currently paused. "
        '<a href="mailto:boss@treylabs.com">Get in touch</a> if you have questions.',
        "cancelling": "Your subscription is scheduled to be canceled. "
